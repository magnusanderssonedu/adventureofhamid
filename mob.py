...
class Mob:
    ...
    def __init__(self,hp=0,description="Mine",aggressive=False,attack=10,attacktrigger=0.3,fleetrigger=0.2,pic="mine"):
        self.hp = hp
        ...
        self.me = pygame.image.load(os.path.join('data', self.picpicker[pic]));
